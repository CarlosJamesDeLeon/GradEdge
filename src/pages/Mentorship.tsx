    ...
    return (
        <div className="w-full pb-20 md:pb-0 font-sans w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    { name: 'Felix Ponce', role: 'SWE at Google', major: 'CS Alumnus', rating: 4.9, sessions: 124 },
                    { name: 'Renz Etcuban', role: 'CS Graduate', major: 'DSA', rating: 5.0, sessions: 89 },
                    { name: 'John David Velos', role: 'Web Designer', major: 'UI/UX', rating: 4.8, sessions: 210 }
                ].map(mentor => (
